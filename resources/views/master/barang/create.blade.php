                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input name="tanggal_kedaluarsa" type="date" class="form-control" placeholder="Select date" id="datepicker-1">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input name="tanggal_pembelian" type="date" class="form-control" placeholder="Select date" id="datepicker-2">
                                        <div class="input-group-append">
                                        <span class="input-group-text">
                                            <i class="fa fa-calendar-alt"></i>
                                        </span>
                            ...
                            <div class="col-2">
                                <div class="form-group">
                                    <label for="harga_jual_1">Harga Jual 1 + PPN 10%</label>
                                    <input type="text" name="harga_jual_1" class="form-control" id="harga_jual_1" required>
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="form-group">
                                    <label for="harga_jual_2">Harga Jual 2 + PPN 20%</label>
                                    <input type="text" name="harga_jual_2" class="form-control" id="harga_jual_2" required>
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="form-group">
                                    <label for="harga_jual_3">Harga Jual 3 + PPN 30%</label>
                                    <input type="text" name="harga_jual_3" class="form-control" id="harga_jual_3" required>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
