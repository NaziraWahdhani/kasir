...
$(function() {
    ...
    if ($('#sidebar .singgle-item a[href="'+window.location.href+'"]')) {
        $('#sidebar .singgle-item a[href="'+window.location.href+'"]').addClass('text-white');
        $('#sidebar .singgle-item a[href="'+window.location.href+'"]').parent().addClass('bg-purple');
        $('#sidebar .menu-item .menu-submenu .menu-item a[href="'+window.location.href+'"]').addClass('text-white');
        $('#sidebar .menu-item .menu-submenu .menu-item a[href="'+window.location.href+'"]').addClass('bg-purple');
        $('#sidebar .menu-item .menu-submenu .menu-item a[href="'+window.location.href+'"]').parent().parent().parent().addClass('bg-purple');
        $('#sidebar .menu-item .menu-submenu .menu-item a[href="'+window.location.href+'"]').parent().parent().parent().children('.menu-item-toggle').addClass('text-white active');
